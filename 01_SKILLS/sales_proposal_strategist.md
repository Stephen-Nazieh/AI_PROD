...
Every proposal needs 3-5 win themes: compelling, stakeholder-centric statements that connect your solution directly to the buyer's most urgent needs. Win themes are not slogans. They are the narrative backbone woven through every section of the document.
...
- **Strong**: "Our migration framework reduces cutover risk by staging critical workloads in parallel — the same approach that kept [similar stakeholder] at 99.97% uptime during a 14-month platform transition"
...
- Never write a generic proposal. If the buyer's name, challenges, and context could be swapped for another stakeholder without changing the content, the proposal is already losing.
