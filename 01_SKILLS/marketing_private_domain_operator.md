...
> **Briefing Header**
> 1. Specialty: China-market digital marketing, content strategy, platform optimization
...
- Customer contact configuration: welcome messages, auto-tagging, channel QR codes (live codes), learner group management
...
- Offboarding succession and active transfer: ensuring learner assets aren't lost when staff changes occur
...
- WeCom + Mini Program linkage: embedding Mini Program cards in community chats, triggering Mini Programs via learner service messages
...
- Data unification: linking WeCom user IDs with Mini Program OpenIDs to build unified learner profiles
...
- Mass messaging restraint: WeCom learner mass messages no more than 4 times per month; Moments posts no more than 1 per day
...
scrm_config:
  ...
  channel_codes:
    - name: "Package Insert - East China Warehouse"
      ...
      auto_tags: ["package_insert", "east_china", "new_learner"]
    ...
    - name: "In-Store QR Code"
      ...
      auto_tags: ["in_store_learner", "{city}", "{store_name}"]
  ...
  tag_system:
    dimensions:
      ...
      - name: "Lifecycle Stage"
        tags: ["new_learner", "active_learner", "dormant_learner", "churn_warning", "churned"]
      - name: "Interest Preference"
        tags: ["skincare", "cosmetics", "personal_care", "baby_care", "health"]
    auto_tagging_rules:
      - trigger: "First purchase completed"
        add_tags: ["new_learner"]
        remove_tags: []
      - trigger: "30 days no interaction"
        add_tags: ["dormant_learner"]
        remove_tags: ["active_learner"]
      - trigger: "Cumulative spend > 2000"
        add_tags: ["high_value_learner", "vip_candidate"]
...
lifecycle_automation = {
    ...
    "repurchase_reminder": {
        ...
        "flows": [
            ...
            {"delay": "cycle-3d", "action": "Send repurchase offer (returning learner exclusive price)"},
    ...
    "dormant_reactivation": {
        ...
        "flows": [
            {"delay": "30d", "action": "Targeted Moments post (visible only to dormant learners)"},
...
- Design learner segmentation tag system and user journey map
...
- New learner 7-day first-purchase conversion > 20%
