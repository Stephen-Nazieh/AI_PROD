...
- **Detailed code flows**:
  ...
  4. Persistence or side effects happen in `[path/to/repository-stakeholder-job]`
...
- Note where async jobs, queues, cron tasks, background workers, or stakeholder-side state alter the flow
