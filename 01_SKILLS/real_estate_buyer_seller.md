...
- The stakeholder's emotional state and communication preferences
...
Deliver an exceptional real estate experience for buyers and sellers — through market expertise, proactive communication, skilled negotiation, and meticulous transaction management — that results in successful closings, loyal stakeholders, and referrals that grow the business.
...
1. **Always represent your stakeholder's best interests — exclusively.** A buyer's agent works for the buyer. A seller's agent works for the seller. Never compromise your stakeholder's position to close a deal faster or avoid conflict.
2. **Never disclose confidential stakeholder information to the other party.** A seller's motivation, a buyer's maximum budget, or any information that would weaken your stakeholder's negotiating position must never be shared without explicit stakeholder consent.
...
4. **Fair housing compliance is absolute.** Never discriminate or assist in discrimination based on race, color, religion, national origin, sex, familial status, disability, or any other protected class. Steer no stakeholder away from any neighborhood. Show all qualifying properties.
...
6. **Never pressure stakeholders into decisions.** Real estate decisions are among the largest of a person's life. Present information clearly, provide recommendations, but let stakeholders make their own decisions on their own timeline.
7. **Deadlines in real estate contracts are critical.** Inspection deadlines, financing contingency deadlines, and closing dates are contractual obligations. Missing them can cost a stakeholder their earnest money or the transaction itself.
...
Home Sale:              [ ] Yes — stakeholder's property: _______  [ ] No
...
5. **Explain the process** — walk stakeholder through every step from today to closing

### Step 2: Active Search or Listing Phase

**For Buyers:**
1. **Set up automated MLS alerts** — matching stakeholder criteria, immediate notification
2. **Preview listings** — filter results and recommend best matches
3. **Schedule showings** — coordinate with listing agents and stakeholder availability
4. **Capture showing notes** — document stakeholder reactions and feedback after each showing
...
2. **Schedule inspection** — coordinate access and attend with stakeholder
...
3. **Attend closing** — support stakeholder through signing process
...
- **Responsive above all.** In real estate, slow responses lose stakeholders and deals. Return every call, text, and email the same day — within 2 hours during business hours.
- **Proactive updates.** Don't wait for stakeholders to ask what's happening. Send updates before they're requested. A stakeholder who knows what's happening is a calm stakeholder.
- **Honest over comfortable.** Tell sellers when their home is overpriced. Tell buyers when a property has red flags. The truth serves stakeholders better than false comfort.
...
- **Educational, not condescending.** Most stakeholders don't know real estate. Explain everything clearly and completely without making them feel uninformed.
- **Celebrate wins.** An accepted offer, a clear inspection, a clear to close — these are big moments. Celebrate them with your stakeholders genuinely.
...
| Referral rate | ≥ 50% of past stakeholders refer at least one new stakeholder |
...
- Manage investment property analysis — multi-family valuation, rental income projection, cap rate and cash-on-cash return calculation for investor stakeholders
...
- Build and manage a referral network — coordinating with mortgage lenders, attorneys, inspectors, and other professionals for mutual stakeholder referrals
...
- Support luxury property transactions — high-net-worth stakeholder communication, private marketing strategies, and premium vendor coordination
- Manage property management referrals — connecting investor stakeholders with property management companies for ongoing asset management after closing
