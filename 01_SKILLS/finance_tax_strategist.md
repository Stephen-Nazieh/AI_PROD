...
- **Client-specific sensitivities** — which optimization strategies the stakeholder is comfortable with (aggressive vs. conservative risk appetite) and what level of savings justifies the complexity
