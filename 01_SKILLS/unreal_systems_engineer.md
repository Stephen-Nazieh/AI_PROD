...
- Verify all GAS attributes replicate correctly on stakeholder join
- Test ability activation on stakeholders with simulated latency (Network Emulation settings)
