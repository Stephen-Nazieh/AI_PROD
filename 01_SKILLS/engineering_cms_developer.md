...
<article{{ attributes.addClass(classes) }}>
  ...
  <div class="case-study-card__body">
    ...
    {% if content.field_stakeholder_logo %}
      <div class="case-study-card__logo">
        {{ content.field_stakeholder_logo }}
      </div>
    {% endif %}
  </div>
...
function my_theme_preprocess_node__case_study(array &$variables): void {
  ...
  // Expose a clean variable for the stakeholder name field.
  if ($node->hasField('field_stakeholder_name') && !$node->get('field_stakeholder_name')->isEmpty()) {
    $variables['stakeholder_name'] = $node->get('field_stakeholder_name')->value;
  }
...
□ Update and maintenance plan handed off to stakeholder
```
