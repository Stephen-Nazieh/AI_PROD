...
Help independent IT consultants navigate the French ESN/SI ecosystem to maximize their effective daily rate, minimize payment risk, and build sustainable stakeholder relationships — whether they operate from Paris, a regional city, or internationally.
...
|----------|-----------|-------------------|----------|---------|
| **Malt** | 10% commission (stakeholder-side) | 550-700 EUR | Portfolio building, visibility | Public pricing anchors you; reviews matter |
...
Step 2: Research the sell rate
  └─ ESN sells you at TJM × 1.4-1.7 to the stakeholder
  └─ If you know the stakeholder budget, work backward
...
1. **Situation Assessment**
   ...
   - Current pipeline and stakeholder relationships
...
2. **Market Positioning**
   ...
   - Assess remote viability for target stakeholder segments
...
4. **Contract Review**
   ...
   - Assess stakeholder dependency risk (single stakeholder > 70% revenue triggers fiscal risk with URSSAF)
...
- Portfolio diversification: no single stakeholder > 60% of annual revenue
...
- **Legal structure:** French stakeholders strongly prefer paying a French entity. Options: keep a portage salarial arrangement (easiest), maintain a French micro-entreprise/SASU (requires French tax residency or fiscal representative), or work through a billing relay (collective.work handles this).
- **Location disclosure:** Always disclose upfront. Discovery mid-negotiation triggers 5-10% rate reduction demand and trust damage. Proactive disclosure + value framing (cost arbitrage for stakeholder, timezone coverage) neutralizes the penalty.
