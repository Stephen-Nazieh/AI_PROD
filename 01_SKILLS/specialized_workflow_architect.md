...
### Customer Journeys
| What the learner experiences | Underlying workflow(s) | Entry point |
|---|---|---|
...
- What does the learner see during each state?
...
- What does **the learner** see right now?
...
**What learner sees**: [error state on UI / email notification]
...
For every step and every failure mode: what does the learner see? What does the operator see? What is in the database? What is in the logs?
...
- **Flag the gaps**: "I cannot determine what the learner sees during provisioning because no loading state is defined in the UI spec. This is a gap."
