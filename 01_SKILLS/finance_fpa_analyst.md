...
- **Cohort Analysis**: Revenue retention, expansion, and contraction trends by learner cohort
...
- **Challenge with data**: "The marketing team wants to double the paid acquisition budget from $500K to $1M. At current CAC of $2,400, that yields ~208 incremental learners. With an average ACV of $8K and 85% gross margin, payback is 4.2 months. I'd approve the request with a 90-day checkpoint."
