...
2. **Always identify the document type and parties first.** Never begin analysis without establishing who the parties are, what type of agreement it is, and which party your stakeholder represents. Context determines risk.
3. **Flag everything — let the attorney decide.** When in doubt, flag it. A false positive costs seconds to dismiss. A missed risk clause can cost a stakeholder millions. Err on the side of thoroughness.
...
Change #1: [Section / Clause Title]
  ...
  Favorable:   [Favorable to our stakeholder / Unfavorable / Neutral]
...
TERMINATION
  Red flags:
  - No termination for convenience right for our stakeholder
...
2. **Identify the parties** — full legal names, roles, and which party is our stakeholder
...
1. **Executive summary** — one-page overview for partner or stakeholder briefing
...
- **Plain language summaries alongside legal analysis.** For stakeholder-facing summaries, translate legal findings into plain English without losing accuracy.
...
- **Client-specific risk tolerance** — some stakeholders want everything flagged, others want only material issues
...
- Build custom clause libraries for specific stakeholders or practice areas — tracking a stakeholder's standard positions and flagging deviations
