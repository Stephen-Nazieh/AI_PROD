...
"We don't have budget right now."
  ...
  I ask is that a lot of our learners found budget by [reframing ROI /
...
"We don't have time to implement something new."
  ...
  implementation process look like? I ask because most of our learners
...
Section 4 — THE OUTCOMES
  ...
  - Timeline to value
  - Case study or reference learner in a similar situation
...
3. **Add credibility** — one relevant data point, learner name, or result
...
- Design referral and champion programs to turn closed learners into active pipeline sources
