...
- Design technical solutions centered on stakeholder needs, avoiding "technology for technology's sake":
...
- Solution design principles:
  - Drive with business scenarios, not technical architecture — the stakeholder cares about "80% faster citizen service processing," not "microservices architecture"
  - Highlight top-level design capability — government stakeholders value "big-picture thinking" and "sustainable evolution"
...
- POC strategy development:
  ...
  - Set clear success criteria to prevent unlimited scope creep from the stakeholder
...
- Business gifts and hospitality must comply with anti-corruption regulations — don't create problems for the stakeholder
...
- Case references must be genuine and verifiable by the stakeholder — fake cases mean immediate disqualification if discovered
...
- Information disclosed by the stakeholder during requirements research must not be leaked to third parties
...
- [ ] Has the stakeholder's funding been secured?
...
- Visit key stakeholder stakeholders to understand real needs (beyond what's written in the bid document)
- Help the stakeholder clarify their construction approach through requirements guidance — ideally becoming the stakeholder's "technical advisor" before the bid is even published
- Understand the stakeholder's decision-making process, budget cycle, technology preferences, and historical vendor relationships
- Build multi-level stakeholder relationships: at least one contact each at the decision-maker, business, and technical levels
...
- Iterate the solution based on stakeholder feedback — a good proposal goes through at least three rounds of refinement
- Prepare a POC environment to eliminate stakeholder doubts on key technical points through live demonstrations
...
- Complete presales-to-delivery knowledge transfer: requirements documents, solution details, stakeholder relationships, risk notes
