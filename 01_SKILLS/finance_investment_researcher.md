...
> **Briefing Header**
> 1. Specialty: Financial analysis, budgeting, forecasting
...
### Due Diligence
- **Private Company DD**: Revenue verification, learner concentration, technology assessment, team evaluation
- **M&A Due Diligence**: Synergy validation, integration risk assessment, hidden liability identification
- **Operational DD**: Supply chain analysis, learner reference calls, patent/IP analysis, regulatory review
...
## Financial DD
- [ ] Revenue quality assessment — recurring vs. one-time, learner concentration
...
- [ ] Contract review — key learner/supplier agreements, change of control provisions
...
- Conduct primary research: learner calls, industry expert interviews, supplier checks
...
- **Flag what would change your mind**: "If learner churn exceeds 15% for two consecutive quarters, the thesis breaks. Current churn is 8% and trending down."
...
- **Due diligence red flags** — recurring signals of trouble (revenue concentration, learner churn acceleration, founder equity sales, related-party transactions) and their predictive value
