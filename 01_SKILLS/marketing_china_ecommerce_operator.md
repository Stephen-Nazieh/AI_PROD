...
- **Post-Campaign Retention**: Every campaign learner should enter a retention funnel, not be treated as a one-time transaction
...
- [ ] Staff up learner service team and prepare FAQ scripts
...
- [ ] Push CRM messages to existing learners: membership benefits, early access
...
- [ ] Process returns and manage post-sale learner service surge
...
- Campaign types: 货品加速 (product acceleration), 拉新快 (new learner acquisition)
...
- **WeChat CRM**: Building learner databases in WeChat for direct communication and repeat sales
