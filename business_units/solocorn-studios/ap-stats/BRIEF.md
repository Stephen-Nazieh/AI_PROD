# Business Unit: AP Statistics Movie Series

- **Company:** Solocorn Studios (`solocorn-studios`)
- **Slug:** `ap-stats`
- **Channel:** 2
- **Domain:** Story-driven multi-episode AP Statistics seasons mapped to the College Board catalog
- **Paperclip team:** `ap-stats`
- **Paperclip project:** `23b2f710-b364-4263-b1e7-bacace21ba62`
