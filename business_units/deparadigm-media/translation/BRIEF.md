# Business Unit: Multi-Language Translation Factory

- **Company:** DeParadigm Media (`deparadigm-media`)
- **Slug:** `translation`
- **Channel:** 3
- **Domain:** Automated Spanish and Mandarin dubbing via XTTS v2 voice cloning
- **Paperclip team:** `translation`
- **Paperclip project:** `8da8fae2-7add-4252-9c99-4a9e5f1742b0`
