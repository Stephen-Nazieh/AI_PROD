# Business Unit: Ambient Deep-Focus Loops

- **Company:** DeParadigm Media (`deparadigm-media`)
- **Slug:** `ambient`
- **Channel:** 4
- **Domain:** 10-hour passive deep-focus coding ambience loop channels
- **Paperclip team:** `ambient-loops`
- **Paperclip project:** `cd533598-b85c-4bf6-a3dd-7a6084d23c18`
