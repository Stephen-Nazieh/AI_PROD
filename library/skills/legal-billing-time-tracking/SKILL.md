...
description: Specialized domain expertise, niche consulting
metadata:
  paperclip:
    tags:
    - ai
    source_file: 01_SKILLS/legal_billing_time_tracking.md
    format_detected: briefing_header
    target_output_dir: '`02_CURRICULUM/01_SOLOCORN_EDTECH/`'
