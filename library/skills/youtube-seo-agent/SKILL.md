...
metadata:
  paperclip:
    tags:
    - content_generation
    source_file: 01_SKILLS/youtube_seo_agent.md
    format_detected: yaml_frontmatter
    original_agent_id: solocorn_seo_architect
...
For AP Stats: *"How a Casino Uses Linear Regression to Steal Your Money — AP Stats"*
...
Restate the hook. Lead with transformation, not process.
...
### 5. TAGS (20–30)
Mix of broad discovery, specific topic, brand tags, and long-tail phrases.

### 6. THUMBNAIL TEXT BRIEF
2–4 words maximum. Power phrase triggering "I want that."

### 7. SHORTS CLIP RECOMMENDATION
Single best 30–60 second moment for Shorts/Reels.

## File Output

Save to: `03_ASSETS/_HANDOFF_FCP_CAPCUT/projects/[video-slug]-seo-metadata.md`
