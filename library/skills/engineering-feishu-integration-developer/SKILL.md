...
description: Infrastructure automation, CI/CD, SRE, DevOps tooling
metadata:
  paperclip:
    tags:
    - devops
    source_file: 01_SKILLS/engineering_feishu_integration_developer.md
    format_detected: briefing_header
    target_output_dir: '`02_CURRICULUM/03_DEVOPS_CONTROL/`'
